...
public class DriveTrain extends Subsystem {
	...
	private final int MAX_RPM = 3127;
...
//	private static final double GEAR_RATIO = 12.75;
	...
	public DriveTrain() {
		...
		straightController = new PIDController(.03, 0, 0, navx, new PIDOutput() {
			public void pidWrite(double output) {
				// TODO:
				// - does the sign of output matter? can we just add
				double lmove = leftMaster.getSetpoint();
				double rmove = rightMaster.getSetpoint();
				leftMaster.set(lmove + output);
				rightMaster.set(rmove + output);
			}
		});
		straightController.setOutputRange(-MAX_RPM, MAX_RPM);

		turnController = new PIDController(.03, 0, 0, navx, new PIDOutput() {
			public void pidWrite(double output) {
	...
	public void updateSmartDashboard() {
		...
		SmartDashboard.putData("Turn PID", straightController);
...
//		return average / (Math.PI * WHEEL_DIAMETER * GEAR_RATIO);
	...
	public void velocityTank(double speed, double rotate) {
